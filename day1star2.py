    ...
    with open(filepath, 'r') as file:
        ...
        for line in lines:
            ...
            if match:
                ...
                if currentSpot > 99:
                    # had +99 here for longest time causing wrong answer.
                    # Highest number is 99, brain wanted to think 99, but
                    # actually there were 100 positions, so it has to be mod
                    # 100.
